...
def CastRays(screen, turret, edgeSystem: ChunkSystem, MapAsCells, tConstants, threeDview=True) -> list:
	...
	if not threeDview:
		pygame.draw.polygon(screen, (255, 239, 99), twoD_Ray_Polygon_Points)
